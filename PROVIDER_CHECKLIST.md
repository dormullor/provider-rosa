...
The [provider-rosa](https://github.com/crossplane/provider-rosa) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-rosa](https://github.com/crossplane-contrib/provider-jet-rosa) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-rosa/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-rosa/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-rosa/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-rosa/blob/main/hack/boilerplate.go.txt)
...
The [provider-rosa](https://github.com/crossplane/provider-rosa)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-rosa/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-rosa/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue rosas (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-rosa/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Rosas: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-rosa/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
