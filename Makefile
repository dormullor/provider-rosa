...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Rosa CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Rosa controllers
...
# This target prepares repo for your provider by replacing all "rosa"
